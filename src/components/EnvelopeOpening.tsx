    ...
    >
      <AnimatePresence mode="wait">
          ...
          >
            <div className="relative w-80 h-56">
              ...
              <svg viewBox="0 0 160 110" className="w-full h-full">
                ...
                >
                  <circle cx="0" cy="0" r="12" fill="hsl(var(--seal-burgundy))" />
                  <path
        ...
        {stage === "letter" && (
          <motion.div
            key="letter"
            className="bg-background rounded-xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto p-8"
            initial={{ opacity: 0, y: 50, scale: 0.9 }}
            animate={{ opacity: 1, y: 0, scale: 1 }}
            transition={{ duration: 0.5 }}
          >
            <div className="paper-texture min-h-[400px] p-6 rounded-lg border border-border">
