  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        seal: {
          DEFAULT: "hsl(var(--seal-rose))",
          dark: "hsl(var(--seal-rose-dark))",
        },
      ...
      keyframes: {
        ...
        "drift": {
          ...
          "33%": { transform: "translateY(-10px) translateX(5px) rotate(5deg)" },
      ...
      boxShadow: {
        ...
        "soft": "0 4px 20px -5px hsl(var(--pastel-rose) / 0.5)",
        "dreamy": "0 10px 40px -10px hsl(var(--pastel-rose) / 0.3), 0 4px 15px -5px hsl(var(--pastel-lavender) / 0.2)",
      },
    },
  },
